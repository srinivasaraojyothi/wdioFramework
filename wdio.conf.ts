...
const customCommands = require("./dist/helper");
export const config: WebdriverIO.Config = {
    ...
    capabilities: [{
        ...
        "app": "D:\\Users\\sjyothi\\Repos\\pythonseleniumFramework\\Airbnb_v22.21_apkpure.com.apk",
   ...
   // baseUrl: 'http://test:test-password@localhost:4444/wd/hub',
    //
    baseUrl: 'https://webdriver.io/docs/frameworks/#cucumber-options',
    //hostname: "localhost",
   // path: "/wd/hub",
    port: 4723,
    //protocol: "http", 
